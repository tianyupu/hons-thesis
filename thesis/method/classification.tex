...
in the hidden layer, and one output node.}
\label{fig:mlp}
\end{figure}
...
scaling factor and $t$ indicates how much to translate the range by. If $s=1$
...
K* and our proposed algorithm, Ranked Distance.
...
to our proposed Ranked Distance Nearest Neighbours algorithm.
...
described our proposed new algorithm, Ranked Distance Nearest Neighbours.
The reason
