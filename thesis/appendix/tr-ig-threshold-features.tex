\begin{table}[htbp]
\caption{Features selected from the discretised trauma data set at varying thresholds of information gain. Features shown are in order from highest to lowest information gain.}
\resizebox{\linewidth}{!}{%
...
\begin{table}[htbp]
\caption{Features selected from the non-discretised trauma data set at varying thresholds of information gain. Features shown are in order from highest to lowest information gain.}
\resizebox{\linewidth}{!}{%
\begin{tabular}{|r|r|r|p{9.5cm}|}
\hline
