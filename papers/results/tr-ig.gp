...
plot "tr-ig.dat" u 1:($6*100) t 'LR' w l ls 2, \
  "tr-ig.dat" u 1:($7*100) t 'SVM' w l ls 4, \
  "tr-ig.dat" u 1:($8*100) t '1NN' w l ls 5, \
  "tr-ig.dat" u 1:($9*100) t '20NN' w l ls 6, \
  "tr-ig.dat" u 1:($10*100) t 'RD' w l ls 7, \
  "tr-ig.dat" u 1:($11*100) t 'K*' w l ls 8, \
  "tr-ig.dat" u 1:($12*100) t 'MLP' w l ls 11, \
  "tr-ig.dat" u 1:($17*100) t 'LR' w l ls 22, \
  "tr-ig.dat" u 1:($18*100) t 'SVM' w l ls 24, \
  "tr-ig.dat" u 1:($19*100) t '1NN' w l ls 25, \
  "tr-ig.dat" u 1:($20*100) t '20NN' w l ls 26, \
  "tr-ig.dat" u 1:($21*100) t 'RD' w l ls 27, \
  "tr-ig.dat" u 1:($22*100) t 'K*' w l ls 28, \
...
plot "tr-ig.dat" u 1:28 t 'LR' w l ls 2, \
  "tr-ig.dat" u 1:29 t 'SVM' w l ls 4, \
  "tr-ig.dat" u 1:30 t '1NN' w l ls 5, \
  "tr-ig.dat" u 1:31 t '20NN' w l ls 6, \
  "tr-ig.dat" u 1:32 t 'RD' w l ls 7, \
  "tr-ig.dat" u 1:33 t 'K*' w l ls 8, \
  "tr-ig.dat" u 1:34 t 'MLP' w l ls 11, \
  "tr-ig.dat" u 1:39 t 'LR' w l ls 22, \
  "tr-ig.dat" u 1:40 t 'SVM' w l ls 24, \
  "tr-ig.dat" u 1:41 t '1NN' w l ls 25, \
  "tr-ig.dat" u 1:42 t '20NN' w l ls 26, \
  "tr-ig.dat" u 1:43 t 'RD' w l ls 27, \
  "tr-ig.dat" u 1:44 t 'K*' w l ls 28, \
